...
import textImage from "../../public/images/techs.svg";
    ...
    <>
     ...
     <main className={styles.container}>
      ...
      <div className={styles.nextLevelContent}>
        <Image src={textImage} alt="Tecnologias" />
        <h2>Mais de <span className={styles.alunos}> 15 mil</span> já levaram sua carreira</h2>
        <span>E você vai perer a chance de evoluir de uma vez por todas?</span>
